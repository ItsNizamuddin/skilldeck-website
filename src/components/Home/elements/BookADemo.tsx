            ...
            <div className="container mx-auto px-2 lg:px-0">
                <div className="flex flex-col lg:flex-row justify-between items-center gap-12">
                    ...
                    <div className="lg:sticky lg:top-24 space-y-6 lg:max-w-2xl">
                        ...
                        <div className=" inline-block rounded-full bg-brand-primary/10 px-4 py-1.5 font-semibold text-xs tracking-wider uppercase">
                        ...
                        <div className="flex flex-col md:flex-row lg:flex-col gap-8">
                            <div className="flex gap-5 items-center">
                                ...
                                <div>
                                    <h3 className="body-large text-brand-dark font-semibold">Virtual Walkthrough</h3>
                                    <p className="body-medium text-gray-600 ">30-minute interactive session with our experts.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-5 items-center">
                                ...
                                <div>
                                    <h3 className="body-large text-brand-dark font-semibold">On-Premise Presentation</h3>
                        ...
                        <div className=" bg-[linear-gradient(125deg,rgba(92,63,250,1)_0%,rgba(203,59,149,1)_48%,rgba(254,106,27,1)_100%)] rounded-2xl p-5 text-white shadow-xl">
