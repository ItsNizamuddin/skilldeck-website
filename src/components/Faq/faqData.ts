...
/**
 * Shared by the client UI and the server page that emits FAQPage structured
 * data. Both read this list so the schema can never drift from what renders.
 */
...
export const FAQ_CATEGORIES = ['All', 'Getting Started', 'Pricing & Billing', 'Features & Services', 'Support'];
