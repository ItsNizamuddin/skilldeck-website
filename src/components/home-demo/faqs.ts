// FAQ copy lifted verbatim from the production homepage (src/app/page.tsx) so the
// design reference shows the real, full FAQ set rather than a trimmed sample.
export const HOME_DEMO_FAQS: { title: string; value: string }[] = [
        {
