...
export default async function Page() {
    ...
    const HOME_FAQS = [
        {
            title: "Why are training companies moving to SkillDeck?",
            value: "Training companies are moving to SkillDeck because it is not just another LMS or website builder — it is a complete Operating System for Training Companies. SkillDeck combines LMS, CRM, industry-specific CMS, class management, event management, marketing automation, quizzes, SEO automation, lead management, websites, analytics, and 100+ other business-critical features into a single plug-and-play platform.<br/><br/>Most training companies today struggle with managing multiple tools, high software costs, technical complexity, poor website performance, and lack of automation. SkillDeck eliminates these problems by providing enterprise-grade infrastructure that is usually available only to multi-million-dollar training companies. With SkillDeck, even small and medium training institutes can access world-class technology, high-performing websites, automation systems, and scalable operations at an affordable cost."
        },
        {
            title: "Which SkillDeck plan is best for a small training company?",
            value: "For small and growing training companies, the SkillDeck Start Plan is usually the best option. It is designed to provide access to all the essential features required to launch and scale a modern training business without making a heavy investment in technology or operations.<br/><br/>Unlike many platforms that restrict features based on pricing tiers, SkillDeck focuses on helping businesses grow from day one. The Start Plan includes access to LMS, CRM, website management, class scheduling, event management, automation tools, marketing features, and much more. As your business scales, you can easily upgrade or switch plans anytime based on your requirements, usage, and business goals without any disruption."
        },
        {
            title: "Can I get lifetime access to the SkillDeck platform?",
            value: "Yes, SkillDeck offers lifetime access options for businesses that prefer long-term ownership and deployment flexibility. You can also choose to deploy the platform on your own server infrastructure depending on your business requirements and scalability needs.<br/><br/>This option is especially useful for large training companies, enterprises, institutions, or businesses looking for complete infrastructure ownership, higher customization control, and long-term operational stability. To know more about lifetime access pricing, deployment options, and infrastructure support, you can connect with the SkillDeck business team for a customized proposal."
        },
        {
    ...
    const organizationSchema = {
        ...
        "description": "World's 1st Fully Automated Plug & Play Platform For Training Companies. Automate your marketing, sales, operations and various other functional departments.",
        "address": {
            "@type": "PostalAddress",
